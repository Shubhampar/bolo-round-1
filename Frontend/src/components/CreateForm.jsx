import {
  ...
  function CreateForm() {
    ...
    async function uploadImage(file) {
      ...
      formData.append("upload_preset", "v4jwcx6y");
      try {
    ...
    return (
      <div>
        ...
        {/* mapping questions */}
        {question.map((el, ind) => (
          <div key={ind} className="mb-6 text-blue-500 font-bolder text-[20px]">
          <QuestionCard
            key={ind}
            data={el}
            ind={ind}
        ...
        <div className="flex gap-5 justify-center my-5">
          ...
          <button
            className="px-3 py-1 font-bold text-[25px] text-white bg-green-500 rounded-lg"
