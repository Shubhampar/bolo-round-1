...
import CategorizePreview from "../components/PreviewTypes/CategorizePreview";
import ClozePreview from "../components/PreviewTypes/ClozePreview";
import ComprehensionPreview from "../components/PreviewTypes/ComprehensionPreview";
    ...
    <div className="p-5 md:p-10 lg:p-16">
      ...
      {data.title ? (
        <footer className="flex justify-center gap-5">
          ...
          <button
            onClick={fetchData}
            className="bg-red-500 py-1 px-3 text-white font-bold text-[25px] rounded-lg"
          >
            Reset
          </button>
          <button
